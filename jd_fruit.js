...
更新时间：2022-6-25  适配h5st验证签名 读取配置文件中设置的助力码
...
[task_local]
#jd免费水果
5 6-18/6 * * * https://gitee.com/SuperManito/scripts/raw/master/jd_fruit.js, tag=东东农场, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdnc.png, enabled=true
=========================Loon=============================
[Script]
cron "5 6-18/6 * * *" script-path=https://gitee.com/SuperManito/scripts/raw/master/jd_fruit.js,tag=东东农场

=========================Surge============================
东东农场 = type=cron,cronexp="5 6-18/6 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/SuperManito/scripts/raw/master/jd_fruit.js

=========================小火箭===========================
东东农场 = type=cron,script-path=https://gitee.com/SuperManito/scripts/raw/master/jd_fruit.js, cronexpr="5 6-18/6 * * *", timeout=3600, enable=true
...
let shareCodes = [ // 这个列表填入你要助力的好友的shareCode
  //第一组shareCode,不同好友的shareCode中间用@符号隔开
  'd1fbedc210bd4f88b8e4506f0e7f4be1@b9bf43603a0c4aa793d508fe3c6979e6@bc06877e6f8c40f0b51f753daed3fd0f@605c3759291140d986ba884ad9c04cdb@5d54d8ca1eaa4051bb9ead70ef48a170@2fa60f14037d4399a3b578471ed377d2',
  //第二组shareCode,不同好友的shareCode中间用@符号隔开
  '9df67302c7ca43478c2e367fadac719b@95ed258398424a0b8636444dd4432b23@98e7e61495d44845af229aa53e59af1a@5764b1a028cc434cae02f5b6aa3ef0e4@ca1496abd3ce4301a226d7fb21c0b142@5ee7462890494b969ceb00e49321d67f',
  'b0c8fcfc200743d496c69213b6d04add@7783c9d4492f4f008ec8ab7534df21bd@f5bf92ae1f1a44678c5c22fc189b0985@9e219823e9a34e0aa6548b3fef1f26e7@3b4ec87e1c3846409d98beb970d24953@7731e4c82ddc4e6eaeee44261ad040ac',
  '1c6e86acf206433b867ba49725f64653@c8e4c134388447d0a8ebaaebdc5865f6@6a6183883af3480e864bdbb9b6fcee8c@de2a22f8017b4fb7a93eee4ed4cd8d3a@bc0668b3cc9348028dd6adeab1da2cc8@d5aa83ee512648e8bee4b2d8e5a47c65',
]
...
async function jdFruit() {
  ...
  try {
    ...
    if ($.farmInfo.farmUserPro) {
      ...
      await duck();
      const DO_TEN_WATER_AGAIN = process.env.DO_TEN_WATER_AGAIN ? (`${process.env.DO_TEN_WATER_AGAIN}` === 'true') : true;
      if(DO_TEN_WATER_AGAIN){
        console.log('执行再次浇水')
...
async function initForFarm() {
  const functionId = arguments.callee.name.toString();
  $.farmInfo = await request(functionId, {"babelChannel":"121","sid":"dc025a5e5fbd8db7c691c22b5eb8f5dw","un_area":"17_1381_50713_53755","version":16,"channel":1});
...
const appidMap = {"initForFarm":"8a2af","taskInitForFarm":"fcb5a","browseAdTaskForFarm":"53f09","firstWaterTaskForFarm":"0cf1e","waterFriendGotAwardForFarm":"d08ff","ddnc_getTreasureBoxAward":"67dfc","totalWaterTaskForFarm":"102f5","gotThreeMealForFarm":"57b30","waterGoodForFarm":"0c010","choiceGoodsForFarm":"5f4ca","gotCouponForFarm":"b1515","gotStageAwardForFarm":"81591","followVenderForBrand":"71547","gotWaterGoalTaskForFarm":"c901b","gotNewUserTaskForFarm":"de8f8","orderTaskGotWaterForFarm":"eed5c","clockInForFarm":"32b94","clockInFollowForFarm":"4a0b4","waterFriendForFarm":"673a0","awardFirstFriendForFarm":"9b655","awardInviteFriendForFarm":"2b5ca","awardCallOrInviteFriendForFarm":"b0b03","userMyCardForFarm":"86ba5","getCallUserCardForFarm":"2ca57","deleteFriendForFarm":"eaf91","gotLowFreqWaterForFarm":"8172b","getFullCollectionReward":"5c767","getOrderPayLotteryWater":"ef089","receiveStageEnergy":"15507","exchangeGood":"52963","farmAssistInit":"92354","myCardInfoForFarm":"157b6","gotPopFirstPurchaseTaskForFarm":"d432f","limitWaterInitForFarm":"6bdc2","ddnc_surpriseModal":"e81c1","friendInitForFarm":"a5a9c","clockInInitForFarm":"08dc3"};
async function taskUrl(function_id, body = {}) {
  ...
  if (!appidMap[function_id]) {
    ...
    const h5st = await getH5st(appidMap[function_id], h5Params);
    // console.log(h5st);
    url = `${JD_API_HOST}?functionId=${function_id}&appid=signed_wh5&body=${encodeURIComponent(JSON.stringify(body))}&client=android&clientVersion=10.4.3&h5st=${encodeURIComponent(h5st)}`
  }
  return {
    url: url,
    headers: {
